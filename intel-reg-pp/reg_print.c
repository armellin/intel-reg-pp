...
static stREG_PRINT__DEF G_pstXlat[] =
{
    ...
    {REG_PRINT__STRING_MSR_PKG_POWER_LIMIT        , REG_PRINT__ID_MSR_PKG_POWER_LIMIT        , REG_PRINT__ADDR_MSR_PKG_POWER_LIMIT        , REG_PRINT_DE__print_MSR_PKG_POWER_LIMIT   , 0}, //  8
    {REG_PRINT__STRING_MSR_PKG_ENERGY_STATUS      , REG_PRINT__ID_MSR_PKG_ENERGY_STATUS      , REG_PRINT__ADDR_MSR_PKG_ENERGY_STATUS      , REG_PRINT_DE__print_MSR_PKG_ENERGY_STATUS , 0}, //  9
    {REG_PRINT__STRING_MSR_PKG_STATUS             , REG_PRINT__ID_MSR_PKG_STATUS             , REG_PRINT__ADDR_MSR_PKG_STATUS             , REG_PRINT_DE__print_MSR_PKG_STATUS        , 0}, // 10
    {REG_PRINT__STRING_MSR_PPERF                  , REG_PRINT__ID_MSR_PPERF                  , REG_PRINT__ADDR_MSR_PPERF                  , 0                                         , 0}, // 11
    {REG_PRINT__STRING_MSR_CORE_PERF_LIMIT_REASONS_64F, REG_PRINT__ID_MSR_CORE_PERF_LIMIT_REASONS_64F, REG_PRINT__ADDR_MSR_CORE_PERF_LIMIT_REASONS_64F, REG_PRINT_DE__printMsrCorePerfLimitReasons64f, 0}, // 12
    {REG_PRINT__STRING_MSR_CORE_PERF_LIMIT_REASONS, REG_PRINT__ID_MSR_CORE_PERF_LIMIT_REASONS, REG_PRINT__ADDR_MSR_CORE_PERF_LIMIT_REASONS, REG_PRINT_DE__printMsrCorePerfLimitReasons, 0}, // 13
    {REG_PRINT__STRING_IA32_PM_ENABLE             , REG_PRINT__ID_IA32_PM_ENABLE             , REG_PRINT__ADDR_IA32_PM_ENABLE             , 0                                         , 0}, // 14
    {REG_PRINT__STRING_IA32_HWP_CAPABILITIES      , REG_PRINT__ID_IA32_HWP_CAPABILITIES      , REG_PRINT__ADDR_IA32_HWP_CAPABILITIES      , 0                                         , 0}, // 15
    {REG_PRINT__STRING_IA32_HWP_REQUEST_PKG       , REG_PRINT__ID_IA32_HWP_REQUEST_PKG       , REG_PRINT__ADDR_IA32_HWP_REQUEST_PKG       , 0                                         , 0}, // 16
    {REG_PRINT__STRING_IA32_HWP_INTERRUPT         , REG_PRINT__ID_IA32_HWP_INTERRUPT         , REG_PRINT__ADDR_IA32_HWP_INTERRUPT         , 0                                         , 0}, // 17
    {REG_PRINT__STRING_IA32_HWP_REQUEST           , REG_PRINT__ID_IA32_HWP_REQUEST           , REG_PRINT__ADDR_IA32_HWP_REQUEST           , 0                                         , 0}, // 18
    {REG_PRINT__STRING_IA32_HWP_PECI_REQUEST_INFO , REG_PRINT__ID_IA32_HWP_PECI_REQUEST_INFO , REG_PRINT__ADDR_IA32_HWP_PECI_REQUEST_INFO , 0                                         , 0}, // 19
    {REG_PRINT__STRING_IA32_HWP_STATUS            , REG_PRINT__ID_IA32_HWP_STATUS            , REG_PRINT__ADDR_IA32_HWP_STATUS            , 0                                         , 0}, // 20
};
